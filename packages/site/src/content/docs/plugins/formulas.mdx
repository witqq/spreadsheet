...
description: "Spreadsheet formulas with cell references, 20+ built-in functions, and automatic recalculation."
---
...
Signature for built-in function implementations used by the evaluator.
