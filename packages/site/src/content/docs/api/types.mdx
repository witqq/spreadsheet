...
- `getWidth` — compute reserved width for left/right decorators. Ignored for overlay/underlay.
- `render` — draw the decorator in its allocated area.
- `getHitZones` — optional interactive zones within the decorator's area.
