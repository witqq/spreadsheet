...
export const scenarios: Scenario[] = [
  { id: 'basic-default', description: 'Default table (7 columns, 50 rows)', component: BasicDefault },
  ...
  { id: 'basic-large-dataset', description: 'Large dataset (1000 rows)', component: BasicLargeDataset },
  { id: 'columns-narrow', description: 'Very narrow columns (40px each)', component: ColumnsNarrow },
  ...
  { id: 'merged-cells', description: 'Several merged regions of different sizes', component: MergedCells },
  { id: 'sorted-filtered', description: 'Sorted ascending with active filter', component: SortedFiltered },
  { id: 'selections', description: 'Range selection (rows 2-5, cols 1-3)', component: Selections },
  { id: 'scroll-states', description: 'Scrolled right and down (partial columns)', component: ScrollStates },
  { id: 'validation-errors', description: 'Cells with validation errors visible', component: ValidationErrors },
  { id: 'demo-frozen-panes', description: 'Demo: frozen rows and columns', component: DemoFrozenPanes },
  { id: 'demo-merging', description: 'Demo: merged cell regions', component: DemoMerging },
  { id: 'demo-clipboard', description: 'Demo: editable table for clipboard', component: DemoClipboard },
  { id: 'demo-undo-redo', description: 'Demo: editable table with undo/redo', component: DemoUndoRedo },
  { id: 'demo-resize', description: 'Demo: resizable columns with constraints', component: DemoResize },
  { id: 'demo-autofill', description: 'Demo: autofill sequences', component: DemoAutofill },
  { id: 'demo-change-tracking', description: 'Demo: cell status indicators', component: DemoChangeTracking },
  { id: 'demo-validation', description: 'Demo: validation rules and errors', component: DemoValidation },
  ...
  { id: 'demo-cell-types', description: 'Demo: custom cell type renderers', component: DemoCellTypes },
  { id: 'demo-row-grouping', description: 'Demo: grouped rows with aggregates', component: DemoRowGrouping },
  { id: 'demo-formula', description: 'Demo: formula plugin (A+B, A×B)', component: DemoFormula },
  { id: 'demo-conditional-format', description: 'Demo: conditional formatting gradient', component: DemoConditionalFormat },
  ...
  { id: 'demo-plugin-showcase', description: 'Demo: plugin showcase table', component: DemoPluginShowcase },
