...
const data: Record<string, unknown>[] = [
  ...
  { id: 3, text: 'Lorem ipsum dolor', number: 0, boolean: true, date: '2023-12-01', currency: 0.99 },
  { id: 4, text: '', number: 3.14, boolean: false, date: '2025-03-01', currency: -500 },
  { id: 5, text: 'Special <>&"chars', number: 999999, boolean: true, date: '2020-01-01', currency: 42.00 },
  { id: 6, text: '日本語テスト', number: 100, boolean: false, date: '2024-07-04', currency: 1000000 },
